...
export default function BookService() {
  ...
  const serviceDetails = {
    wedding: {
      ...
      desc: "Plan your holy union. Ensure baptismal certificates are ready for upload.",
      icon: <HeartOutlined />,
    },
    baptism: {
      title: "Sacrament of Baptism",
      desc: "Welcome a new member into the Christian community with open arms.",
      icon: <UserAddOutlined />,
    },
    confession: {
      title: "Sacrament of Reconciliation",
      desc: "Schedule private spiritual healing and confession with our parish priest.",
      icon: <SafetyCertificateOutlined />,
    },
    anointing: {
      title: "Anointing of the Sick",
      desc: "Request spiritual comfort and healing for the elderly or seriously ill.",
      icon: <MedicineBoxOutlined />,
    },
    communion: {
      title: "First Holy Communion",
      desc: "Register for the Eucharist. Completion of catechism is usually required.",
      icon: <ReadOutlined />,
    },
    burial: {
  ...
  const currentService = serviceDetails[bookingSelected] || {
    title: "",
    desc: "",
  };
          ...
          <div className="services-hero-wrapper">
            ...
            <div className="services-hero-content">
              ...
              <p className="hero-subtitle">
                Experience the grace of the sacraments. Select a path to begin
                your spiritual journey and join our community in faith.
              </p>
            </div>
          </div>
              ...
              <div className="info-container">
                <div className="info-text">
                  ...
                  <p style={{ color: "#7f8c8d", marginBottom: "30px" }}>
                    We have modernized our process to help you prepare for your
                    sacraments with ease.
                  </p>
                  ...
                  <div className="step-card">
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: "0.9rem", color: "#95a5a6" }}>
                        Pick the service you need and read the requirements.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="step-card">
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: "0.9rem", color: "#95a5a6" }}>
                        Submit digital copies of certificates directly through
                        the app.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="step-card">
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: "0.9rem", color: "#95a5a6" }}>
                        Our office will contact you once your documents are
                        verified.
                      </p>
                    </div>
                  </div>
        ...
        <div className="booking-form-view">
          <div className="service-header">
            <button
              ...
              onClick={() => setBookingSelected(null)}
            >
